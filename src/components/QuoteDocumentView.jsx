...
export default function QuoteDocumentView({ quote, documentRef }) {
  ...
  return (
    <div className="document-preview-container flex justify-center p-2 sm:p-6 bg-[#09101f] overflow-x-auto min-h-full w-full">
      {/* Printable Sheet (Exact A4 dimensions: 794px width x 1123px height at 96 DPI) */}
      <div
        ref={documentRef}
        id="cotizacion-maher-paper"
        className="document-paper shadow-2xl rounded-sm flex flex-col justify-between text-left font-['Inter'] relative select-text"
        style={{
          width: '794px',
          minHeight: '1123px',
          padding: '40px 44px',
